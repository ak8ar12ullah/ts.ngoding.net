...
Dengan cara ini kita bisa narrowing tipe data, tapi jika kita memberikan banyak jenis tipe data sama saja kita meninggalkan keunggulan utama dari typescript sama seperti tipe data `any`.
